...
class UNet(nn.Module):
    ...
    def forward(self, x):
        ...
        print('crop4 size: %d, x9 size: %d' % (x4.size(2), xup.size(2)))
        ...
        print('crop3 size: %d, x9 size: %d' % (x3.size(2), xup.size(2)))
        ...
        print('crop2 size: %d, x9 size: %d' % (x2.size(2), xup.size(2)))
